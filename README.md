...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-bt-bootparse.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-bt-bootparse)

This repository contains the source code for the [BootParse](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.bt.BootParse).

Please see the [issues](https://github.com.bt.BootParse/com-bt-bootparse/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about BootParse? Ask away on the [com-bt-bootparse discussion forum](https://groups.google.com/forum/#!forum/com-bt-bootparse).

<a href="https://play.google.com/store/apps/details?id=com.bt.BootParse" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.bt.BootParse__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.bt.BootParse__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.bt.BootParse.R__) will now be renamed
...
signed with a different key.  Manually uninstall BootParse from your device and
...
BootParse is a result of a template project I've developed over the years as well as
...
BootParse is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.bt.BootParse/com-bt-bootparse/contributors) on
...
[pull requests](https://github.com.bt.BootParse/com-bt-bootparse/pulls).
