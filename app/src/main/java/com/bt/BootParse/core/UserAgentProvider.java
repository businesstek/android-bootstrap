...
import com.bt.BootParse.util.Strings;
 ...
 *
 *      BootParse/1.0 (Android 4.2.2; Genymotion Vbox86p / Generic Galaxy Nexus - 4.2.2 - API 17 - 720x1280; )[preload=false;locale=en_US;clientidbase=]
 *
...
public class UserAgentProvider implements Provider<String> {
    ...
    private static final String APP_NAME = "BootParse";
