...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.bt.BootParse";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "BootParse";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.bt.BootParse.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.bt.BootParse.";
